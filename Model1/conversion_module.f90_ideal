...
CONTAINS
  ...
  DOUBLE PRECISION FUNCTION dlat2y(lat)
    ...
    if(SphericalProjection) then
      ...
      !idlat2y = (lat-latmin)*Earth_Radius*pi/180.0
      dlat2y = (lat-latmin)*100
    else
